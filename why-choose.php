...
<body>
  ...
  <main id="main-content">
        ...
        <div class="row align-items-center">
          <div class="col-xl-6">
            <div class="about__bg about__bg--2 about__bg--3 about__bg--5">
              <img loading="lazy" alt="GryphalCode Team and Expertise Overview"
                src="<?= $base_url ?>/assets/images/bg/about-bg-6.webp" loading="lazy">
            </div>
          </div>
          <div class="col-xl-6">
    ...
    <!-- counter area end -->
    <!-- cta area start -->
    <div class="cta__area cta__area--4 bg_img" data-background="<?= $base_url ?>/assets/images/bg/cta-bg-3.webp"
