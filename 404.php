...
?>
<?php $base_url = '.';
$page_title = "404 | GryphalCode";
$meta_desc = "GryphalCode specializes in 404 services. We build secure, high-performance web and mobile software tailored for your business needs.";
...
<html class="no-js" lang="en">
 <head>
  ...
  <meta content="Page Not Found | GryphalCode" name="twitter:title"/>
