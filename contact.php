        ...
        <div class="col-xl-10">
          <div class="contact__wrap pt-95 pb-95">
            <div class="contact__form">
              <form action="mail.php" aria-label="Contact Form" data-agent-action="submit-contact-inquiry" id="contact-form" method="POST">
                ...
                <div class="row mt-none-30">
                  ...
                  <div class="col-xl-6 mt-30">
                    <div class="form__group">
                      ...
                      <input id="tel" name="phone" pattern="[0-9+\-\s]+" required=""
                        type="tel" />
                    </div>
                  </div>
                  <div class="col-xl-6 mt-30">
