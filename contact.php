...
?>
<?php $base_url = '.';
$page_title = "Contact | GryphalCode";
$meta_desc = "GryphalCode specializes in Contact services. We build secure, high-performance web and mobile software tailored for your business needs.";
...
<noscript><link rel="stylesheet" href="assets/css/responsive.css?v=3"></noscript>
  ...
  <meta content="Contact GryphalCode | Start Your Project Transformation Today" name="twitter:title" />
  <meta
    content="GryphalCode | Enterprise-grade AI integration, custom software engineering, and scalable cloud solutions. Transform your digital vision into reality."
