...
<html class="no-js" lang="en">
 <head>
  ...
  <meta content="https://gryphalcode.com/case-study-details/cloud-migration" property="og:url" />
  ...
  <script type="application/ld+json">
  {
    ...
    "url": "https://gryphalcode.com/case-study-details/cloud-migration",
    "provider": {
      "@type": "Organization",
      "name": "GryphalCode",
     ...
     <div class="col-xl-8 col-lg-8">
      <div class="project-details__content">
       <div class="thumb mb-40">
        <img alt="Cloud Migration Case Study Main Image" class="w-100 project-overview-img" src="<?= $base_url ?>/assets/images/service-previews/cloud-devops.webp" loading="lazy">
       </div>
