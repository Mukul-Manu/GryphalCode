...
<html class="no-js" lang="en">
 <head>
  ...
  <link href="https://gryphalcode.com/case-study-details/whatsapp-business-crm" rel="canonical">
  ...
  <meta content="https://gryphalcode.com/case-study-details/whatsapp-business-crm" property="og:url" />
  ...
  <script type="application/ld+json">
  {
    ...
    "url": "https://gryphalcode.com/case-study-details/whatsapp-business-crm",
    "provider": {
      "@type": "Organization",
      "name": "GryphalCode",
     ...
     <div class="col-xl-8 col-lg-8">
      <div class="project-details__content">
       <div class="thumb mb-40">
        <img alt="CRM Case Study Main Image" class="w-100 project-overview-img" src="<?= $base_url ?>/assets/images/service-previews/it-consultant.webp" loading="lazy">
       </div>
