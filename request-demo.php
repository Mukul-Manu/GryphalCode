...
?>
<?php $base_url = '.';
$page_title = "Request Demo | GryphalCode";
$meta_desc = "GryphalCode specializes in Request Demo services. We build secure, high-performance web and mobile software tailored for your business needs.";
 
$meta_keywords = "Request Demo, GryphalCode Request Demo, Request, Demo, IT company, software development, AI solutions, cloud infrastructure";
?>
﻿
<!DOCTYPE html>
<html class="no-js" lang="en">
 <head>
  ...
  <meta content="Request a Demo | See GryphalCode Innovation in Action" name="twitter:title"/>
