...
?>
<?php $base_url = '.';
$page_title = "Careers | GryphalCode";
$meta_desc = "GryphalCode specializes in Careers services. We build secure, high-performance web and mobile software tailored for your business needs.";
...
<head>
        ...
        <!-- Security & Integrity -->
        <meta content="default-src 'self' https:; script-src 'self' 'unsafe-inline' https://www.googletagmanager.com https://www.google-analytics.com; style-src 'self' 'unsafe-inline' https://fonts.googleapis.com; font-src 'self' https://fonts.gstatic.com; img-src 'self' data: https:;"
...
<noscript><link rel="stylesheet" href="assets/css/responsive.css?v=3"></noscript>
        ...
        <meta content="Careers at GryphalCode | Join the Elite 1% of Global Tech Talent" name="twitter:title" />
        <meta content="GryphalCode | Enterprise-grade AI integration, custom software engineering, and scalable cloud solutions. Transform your digital vision into reality."
