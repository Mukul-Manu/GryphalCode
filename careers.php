                        ...
                        <div class="container">
                                                        ...
                                                        <div class="row">
                                                                <div class="col-xl-6 col-lg-6 mt-30">
                                                                        <img alt="Company Culture"
                                                                                src="assets/images/bg/careers-bg-1.webp"
                                                                                loading="lazy">
                                                                </div>
                                                                <div class="col-xl-6 col-lg-6 mt-30">
                                                                        <img alt="Office Environment"
                                                                                src="assets/images/bg/careers-bg-2.webp"
                                                                                loading="lazy">
                                                                </div>
                                                        </div>
                                ...
                                <div class="row justify-content-center">
                                        <div class="col-xl-8 col-lg-10 mt-30">
                                                <img alt="Join Our Team" src="assets/images/bg/careers-bg-3.webp"
                                                        loading="lazy">
                                        </div>
                                </div>
                        </div>
                                                ...
                                                <div class="support__box support__box--2">
                                                        <div class="icon">
                                                                <img alt="Cutting-edge tech icon" class="default"
                                                                        src="assets/images/icons/support-icon-6.webp"
                                                                        loading="lazy">
                                                                <img alt="Cutting-edge tech hover" class="hover"
                                                                        src="assets/images/icons/support-icon-h-6.webp"
                                                                        loading="lazy">
                                                        </div>
                                                        <div class="content">
                                                                ...
                                                                <p>
                                                                        Work with the latest frameworks, AI tools, and
                                                                        cloud
                                                ...
                                                <div class="support__box support__box--2">
                                                        <div class="icon">
                                                                <img alt="Flexible work icon" class="default"
                                                                        src="assets/images/icons/support-icon-7.webp"
                                                                        loading="lazy">
                                                                <img alt="Flexible work hover" class="hover"
                                                                        src="assets/images/icons/support-icon-h-7.webp"
                                                                        loading="lazy">
                                                        </div>
                                                        <div class="content">
                                                                <h2 class="title mb-15">
                                                                ...
                                                                <p>
                                                                        Balance life and work with our hybrid and remote
                                                                        options
                                                ...
                                                <div class="support__box support__box--2">
                                                        <div class="icon">
                                                                <img alt="Career growth icon" class="default"
                                                                        src="assets/images/icons/support-icon-8.webp"
                                                                        loading="lazy">
                                                                <img alt="Career growth hover" class="hover"
                                                                        src="assets/images/icons/support-icon-h-8.webp"
                                                                        loading="lazy">
                                                        </div>
                                                        <div class="content">
                                                                <h2 class="title mb-15">
                                                                ...
                                                                <p>
                                                                        Upskill with mentoring, certifications, and
                                                                        leadership
                                                ...
                                                <div class="support__box support__box--2">
                                                        <div class="icon">
                                                                <img alt="Gaming zone icon" class="default"
                                                                        src="assets/images/icons/support-icon-9.webp"
                                                                        loading="lazy">
                                                                <img alt="Gaming zone hover" class="hover"
                                                                        src="assets/images/icons/support-icon-h-9.webp"
                                                                        loading="lazy">
                                                        </div>
                                                        <div class="content">
                                                                <h2 class="title mb-15">
                                                                ...
                                                                <p>
                                                                        Recharge your mind in our creative chill zone
                                                                        featuring
                                                                        gaming
                                                ...
                                                <div class="support__box support__box--2">
                                                        <div class="icon">
                                                                <img alt="Lifestyle icon" class="default"
                                                                        src="assets/images/icons/support-icon-10.webp"
                                                                        loading="lazy">
                                                                <img alt="Lifestyle hover" class="hover"
                                                                        src="assets/images/icons/support-icon-h-10.webp"
                                                                        loading="lazy">
                                                        </div>
                                                        <div class="content">
                                                                <h2 class="title mb-15">
                                                                ...
                                                                <p>
                                                                        Enjoy health perks, team outings, and a
                                                                        supportive
                                                                        culture
