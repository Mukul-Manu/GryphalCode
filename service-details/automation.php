        ...
        <div class="row">
          <div class="col-xl-6 col-lg-6 pr-55">
            <div class="service-preview-img">
              <img alt="Automation &amp; SRE Visualization" src="../assets/images/service-previews/automation.webp"
                loading="lazy">
            </div>
          </div>
          ...
          <div class="col-xl-6 col-lg-6 mt-30">
            <div class="service__box">
              <div class="thumb mb-35">
                <img alt="3D Shield Illustration" src="../assets/images/service-features/automation/feature-1.webp"
                  loading="lazy">
              </div>
              <div class="content">
