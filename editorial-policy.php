...
<main id="main-content">
  <section class="pt-120 pb-100">
    <div class="container">
      ...
      <p class="mb-20">We publish practical technology content focused on software delivery, cloud, AI, security, and growth engineering. This policy explains how we maintain quality and trust.</p>
      ...
      <ul>
        ...
        <li>Feedback or correction requests can be shared through our <a href="<?= $base_url ?>/contact">contact page</a>.</li>
      </ul>
    </div>
  </section>
</main>
