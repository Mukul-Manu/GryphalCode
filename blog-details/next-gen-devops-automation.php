                ...
                <div class="col-xl-6 col-lg-6 pr-55">
                    <div class="project-details__content">
                        <div class="thumb blog-hero-thumb mb-35">
                            <img src="<?= $featured_image ?>" alt="Next-Gen DevOps - Main Concept" loading="lazy" style="width:100%; border-radius:16px; box-shadow: 0 20px 40px rgba(0,0,0,0.1); border: 1px solid rgba(0,0,0,0.05);">
                        </div>
                    </div>
                </div>
                <div class="col-xl-6 col-lg-6 pl-20">
                    <div class="about__wrap">
                        <div class="section__heading mb-35">
                            <h2 class="section__heading--title-small"><span class="mr-10">//</span> Cloud / DevOps Professional Insight</h2>
                            <h3 class="section__heading--title">Engineering Strategy & Innovation</h3>
                            <div class="section__heading--content mt-20">
                                <p>To achieve operational excellence in <strong>Cloud / DevOps</strong>, modern enterprises must prioritize a cohesive architectural strategy. The convergence of automated reliability and data-driven scaling is the new standard for industrial performance.</p>
                                ...
                                <div class="row mt-40">
                                    <div class="col-sm-6 mb-20">
                                        <div class="thumb gallery-thumb">
                                            <img src="<?= $image_2 ?>" alt="Next-Gen DevOps - Implementation Flow" loading="lazy" style="width:100%; border-radius:12px; box-shadow: 0 10px 25px rgba(0,0,0,0.05);">
                                        </div>
                                    </div>
                                    <div class="col-sm-6 mb-20">
                                        <div class="thumb gallery-thumb">
                                            <img src="<?= $image_3 ?>" alt="Next-Gen DevOps - Component Detail" loading="lazy" style="width:100%; border-radius:12px; box-shadow: 0 10px 25px rgba(0,0,0,0.05);">
                                        </div>
                                    </div>
                                </div>
