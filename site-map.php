      ...
      <div class="row">
        ...
        <div class="col-lg-4">
          ...
          <ul>
            ...
            <li><a href="<?= $base_url ?>/service-details/security">Security</a></li>
          </ul>
        </div>
        <div class="col-lg-4">
          ...
          <ul>
            ...
            <li><a href="<?= $base_url ?>/blog-details/enterprise-generative-ai-integration">Enterprise Generative AI</a></li>
            ...
            <li><a href="<?= $base_url ?>/blog-details/ai-copilot-rollout-framework">AI Copilot Rollout Framework</a></li>
            <li><a href="<?= $base_url ?>/blog-details/cloud-cost-optimization-model">Cloud Cost Optimization Model</a></li>
            <li><a href="<?= $base_url ?>/blog-details/technical-seo-for-ai-overviews">Technical SEO for AI Overviews</a></li>
            <li><a href="<?= $base_url ?>/blog-details/conversion-tracking-for-b2b-websites">Conversion Tracking for B2B Websites</a></li>
            <li><a href="<?= $base_url ?>/blog-details/security-hardening-sprint-plan">Security Hardening Sprint Plan</a></li>
            <li><a href="<?= $base_url ?>/blog-details/llm-ready-content-architecture">LLM-Ready Content Architecture</a></li>
          </ul>
