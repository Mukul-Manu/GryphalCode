...
?>
<?php $base_url = '.';
$page_title = "Case Studies | GryphalCode";
$meta_desc = "GryphalCode specializes in Case Studies services. We build secure, high-performance web and mobile software tailored for your business needs.";
...
<noscript><link rel="stylesheet" href="assets/css/responsive.css?v=3"></noscript>
  ...
  <meta content="Case Studies | Real-World AI &amp; Software Success Stories — GryphalCode" name="twitter:title" />
  <meta
    content="Explore GryphalCode's real-world case studies showcasing AI integration, custom software, and cloud solutions that transformed businesses."
