...
<body>
    ...
    <main id="main-content">
        ...
        <section class="faq-search-area pt-150 pb-155 bg_img"
            data-background="<?= $base_url ?>/assets/images/pattern/faq-pattern.webp">
            <div class="container">
                        ...
                        <div class="faq-search-wrap">
                            <div class="faq-search mb-45">
                                <form action="#" method="get" role="search">
                                    <input aria-label="Search FAQs" id="faq-search-input"
                                        placeholder="Type your questions here" type="search" />
                        ...
                        <div class="accordion faqs faqs--2" id="accordionFaq">
                            ...
                            <div class="card">
                                <div class="card__header" id="heading4">
                                    <h5 class="mb-0 title">
                                        <button aria-controls="collapse4" aria-expanded="false"
                        ...
                        <div class="accordion faqs faqs--2" id="accordionFaq2">
                            ...
                            <div class="card">
                                <div class="card__header" id="heading8">
                                    <h5 class="mb-0 title">
                                        <button aria-controls="collapse8" aria-expanded="false"
                                            class="btn btn-link collapsed" data-target="#collapse8"
                                            data-toggle="collapse" type="button">
                            ...
                            <div class="card">
                                <div class="card__header" id="heading9">
                                    <h5 class="mb-0 title">
                                        <button aria-controls="collapse9" aria-expanded="false"
                                            class="btn btn-link collapsed" data-target="#collapse9"
                                            data-toggle="collapse" type="button">
                            ...
                            <div class="card">
                                <div class="card__header" id="heading10">
                                    <h5 class="mb-0 title">
                                        <button aria-controls="collapse10" aria-expanded="false"
                                            class="btn btn-link collapsed" data-target="#collapse10"
                                            data-toggle="collapse" type="button">
                                ...
                                <div class="card__header" id="heading11">
                                    <h5 class="mb-0 title">
                                        <button aria-controls="collapse11" aria-expanded="false"
                                            class="btn btn-link collapsed" data-target="#collapse11"
                                            data-toggle="collapse" type="button">
                                ...
                                <div class="card__header" id="heading12">
                                    <h5 class="mb-0 title">
                                        <button aria-controls="collapse12" aria-expanded="false"
                                            class="btn btn-link collapsed" data-target="#collapse12"
                                            data-toggle="collapse" type="button">
        ...
        <!-- faq area end -->
        <!-- cta area start -->
        <section class="cta__area cta__area--2 cta__area--3 pt-95 pb-95 bg_img text-center"
            data-background="<?= $base_url ?>/assets/images/bg/cta-bg-3.webp">
            <div class="container">
