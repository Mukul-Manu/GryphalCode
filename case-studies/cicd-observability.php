...
?>
<?php $base_url = '..';
$page_title = "Cicd Observability | GryphalCode";
$meta_desc = "GryphalCode specializes in Cicd Observability services. We build secure, high-performance web and mobile software tailored for your business needs.";
...
<html class="no-js" lang="en">
 <head>
  ...
  <meta content="Case Study: CI/CD &amp; Observability for SaaS | GryphalCode Portfolio" name="twitter:title"/>
  <meta content="Implemented full GitOps with Kubernetes, cutting deployment failures by 89% and release cycles from 2wk → 1day." name="twitter:description"/>
     ...
     <div class="col-xl-8 col-lg-8">
      <div class="project-details__content">
       <div class="thumb mb-40">
        <img alt="Automation Case Study Main Image" class="w-100 project-overview-img" src="../assets/images/service-previews/automation.webp"/ loading="lazy">
       </div>
