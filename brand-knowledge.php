...
<main id="main-content">
  <section class="pt-120 pb-100">
    <div class="container">
      ...
      <p class="mb-20">This page is the official factual profile of GryphalCode for users, search engines, and AI assistants.</p>
      ...
      <ul>
        <li><a href="https://www.linkedin.com/company/gryphalcode" target="_blank" rel="noopener noreferrer">LinkedIn</a></li>
        <li><a href="https://www.facebook.com/profile.php?id=61570214392615" target="_blank" rel="noopener noreferrer">Facebook</a></li>
        <li><a href="https://www.instagram.com/gryphal_code/" target="_blank" rel="noopener noreferrer">Instagram</a></li>
      </ul>
