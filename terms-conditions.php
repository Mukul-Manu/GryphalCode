...
?>
<?php $base_url = '.';
$page_title = "Terms Conditions | GryphalCode";
$meta_desc = "GryphalCode specializes in Terms Conditions services. We build secure, high-performance web and mobile software tailored for your business needs.";
...
<html class="no-js" lang="en">
 <head>
  ...
  <meta content="Terms &amp; Conditions | Clear &amp; Transparent Business Agreements - GryphalCode" name="twitter:title"/>
